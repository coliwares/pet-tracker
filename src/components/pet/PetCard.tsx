        ...
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <PetPhoto
              ...
              sizeClassName="w-24 h-24 rounded-2xl"
              imageClassName="object-cover ring-4 ring-blue-50 group-hover:ring-blue-100 transition-all"
              fallbackClassName="bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow"
